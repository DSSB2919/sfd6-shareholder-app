...
export const ACTIVITY_REWARDS = [
  { type: '食物 / 无酒精饮料', reward: '最高 10% 雪山分', note: '按股东等级与净消费计算' },
  { type: '酒精饮料', reward: '最高 4% 雪山分', note: '不含税与服务费' },
...
export const BENEFITS = [
  ...
  },
  {
    icon: 'percent',
    title: '消费抵扣机制',
    desc: '食物 / 无酒精饮料每 RM100 可抵 30 分；酒精每 RM100 可抵 10 分。',
  },
  {
    icon: 'gift',
    title: '每周股东福利',
  ...
  },
  {
    icon: 'users',
    title: '带客奖励与资源变现',
    desc: '股东带客消费、介绍包场、赞助商、活动合作，可获得 Snow Points 或佣金奖励。',
  },
];